...
namespace BibliotecaApp.Forms
{
    public partial class CartiForm : Form
    {
        ...
        public CartiForm()
        {
            Text = "Cărți";
            InitializeComponent();
            MakeBtn(btnAdd, "➕ Adaugă", Color.FromArgb(34, 139, 34), new Point(10, 12), 130, btnAdd_Click);
            MakeBtn(btnEdit, "✏️ Editează", Color.FromArgb(100, 130, 160), new Point(148, 12), 105, btnEdit_Click);
            MakeBtn(btnDelete, "🗑️ Șterge", Color.FromArgb(196, 43, 43), new Point(261, 12), 95, btnDelete_Click);
            MakeBtn(btnRefresh, "🔄 Reîncarcă", Color.FromArgb(100, 120, 140), new Point(364, 12), 105, btnRefresh_Click);
            LoadData();
        }
